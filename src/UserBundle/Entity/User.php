...
class User extends BaseUser
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="RealizacaoBundle\Entity\Realizacao", cascade={"merge", "remove"}, mappedBy="user")
     **/
    ...
    */
     ...
     * Add realizacaos
     *
     * @param \RealizacaoBundle\Entity\Realizacao $realizacaos
     * @return User
     */
    public function addRealizacao(\RealizacaoBundle\Entity\Realizacao $realizacaos)
    {
     ...
     * @param \RealizacaoBundle\Entity\Realizacao $realizacaos
     */
    public function removeRealizacao(\RealizacaoBundle\Entity\Realizacao $realizacaos)
    {
