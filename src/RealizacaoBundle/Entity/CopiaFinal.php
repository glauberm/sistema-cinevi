...
/**
 * @ORM\Entity(repositoryClass="RealizacaoBundle\Entity\CopiaFinalRepository")
...
class CopiaFinal
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="RealizacaoBundle\Entity\Realizacao", cascade={"all"}, inversedBy="copiaFinal")
     **/
    protected $realizacao;

    /**
     * @ORM\OneToOne(targetEntity="RealizacaoBundle\Entity\Projeto", cascade={"merge"}, inversedBy="copiaFinal")
     **/
    protected $projeto;
    ...
    /**
     * @ORM\OneToOne(targetEntity="RealizacaoBundle\Entity\FichaTecnica", cascade={"all"})
     **/
     ...
     * Set fichaTecnica
     *
     * @param \RealizacaoBundle\Entity\FichaTecnica $fichaTecnica
     * @return CopiaFinal
     */
    public function setFichaTecnica(\RealizacaoBundle\Entity\FichaTecnica $fichaTecnica = null)
    {
     ...
     * Get fichaTecnica
     *
     * @return \RealizacaoBundle\Entity\FichaTecnica
     */
