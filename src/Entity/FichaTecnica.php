...
class FichaTecnica
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Equipe", cascade={"all"}, orphanRemoval=true)
     **/
    protected $equipes;
     ...
     * @return FichaTecnica
     */
    public function addEquipe(\App\Entity\Equipe $equipes)
    {
     ...
     * @param \App\Entity\Equipe $equipes
     */
    public function removeEquipe(\App\Entity\Equipe $equipes)
    {
