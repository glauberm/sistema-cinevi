...
class AuthenticationUpdateEmailController extends Controller
{
    ...
    public function __invoke(Request $request, int $id, string $email): RedirectResponse
    {
        ...
        Session::flash('message', 'Email editado com sucesso. Por favor, entre com seu novo email.');
