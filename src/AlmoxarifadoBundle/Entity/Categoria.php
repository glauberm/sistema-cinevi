...
/**
 * @ORM\Entity(repositoryClass="AlmoxarifadoBundle\Entity\CategoriaRepository")
...
class Categoria
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AlmoxarifadoBundle\Entity\Equipamento", cascade={"merge", "remove"}, mappedBy="categoria")
     **/
