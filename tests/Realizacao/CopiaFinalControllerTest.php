...
namespace App\Tests\Realizacao;
...
class CopiaFinalControllerTest extends AbstractCrudControllerTest
{
    ...
    protected function setUp()
    {
        ...
        $funcao->setAutor($userAtual);
        $funcao->setCreatedIn(new \DateTime());
    ...
    protected function tearDown()
    {
        ...
        $funcao = $this->em->getRepository('App\Entity\Funcao')->find($this->funcaoId);
