...
// Route::post('solicitar-redefinir-senha', [AuthenticationController::class, 'forgotPassword']);

// Route::post('redefinir-senha/{id}', [AuthenticationController::class, 'resetPassword'])->name(
//     'authentication.reset_password',
// );

// Route::post('solicitar-atualizar-email', [AuthenticationController::class, 'requestUpdateEmail']);

// Route::put('atualizar-email/{email}', [AuthenticationController::class, 'updateEmail'])->name(
